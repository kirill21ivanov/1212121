...
public:
    ...
    void setupUi(QMainWindow *MainWindowFin)
    {
        ...
        MainWindowFin->setStyleSheet(QString::fromUtf8("background-color:rgb(43, 43, 44);"));
        centralwidget = new QWidget(MainWindowFin);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        text = new QLabel(centralwidget);
        text->setObjectName(QString::fromUtf8("text"));
        text->setGeometry(QRect(260, 20, 941, 20));
        QFont font1;
        ...
        part_name->setGeometry(QRect(540, 230, 561, 31));
        QFont font2;
...
"color: rgb(255, 255, 255);"));
        ...
        text_2->setGeometry(QRect(430, 159, 161, 31));
        ...
        text_3->setGeometry(QRect(460, 240, 61, 20));
        ...
        win_start->setGeometry(QRect(240, 50, 961, 41));
        QFont font3;
        ...
        text_4->setGeometry(QRect(390, 310, 231, 41));
        QFont font4;
        ...
        part_prog->setGeometry(QRect(630, 390, 151, 41));
        part_prog->setFont(font2);
        part_prog->setStyleSheet(QString::fromUtf8("\n"
"color: rgb(255, 255, 255);"));
        ...
        text_5->setGeometry(QRect(390, 390, 231, 41));
        ...
        text_6->setGeometry(QRect(400, 480, 231, 41));
        ...
        part_ov->setGeometry(QRect(660, 490, 131, 31));
        part_ov->setFont(font2);
        part_ov->setStyleSheet(QString::fromUtf8("\n"
"color: rgb(255, 255, 255);"));
        ...
        part_groups->setGeometry(QRect(590, 160, 161, 31));
        ...
        part_kol->setGeometry(QRect(640, 310, 231, 41));
